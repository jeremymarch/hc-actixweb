...
pub async fn get_session_state(
    ...
    let r = SessionState {
        ...
        move_type: move_type,
        myturn: myturn,
        starting_form: None, //if m.len() == 2 {Some(m[1].answer)} else { None },
        answer: None, //if m.len() > 0 {Some(m[0].answer)} else { None },
        is_correct: None,//if m.len() > 0 {Some(m[0].is_correct)} else { None },
        correct_answer: None,//if m.len() > 0 {Some(m[0].answer)} else { None },
        verb: Some(0),//if m.len() > 0 {Some(m[0].verb)} else { None },
        person: None,
        number: None,
        tense: None,
        voice: None,
